...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 5edaccfd-6a70-42af-9f63-d9399d4da20e
```

> `5edaccfd-6a70-42af-9f63-d9399d4da20e` is the password of the certificate, you can change it to any password you want.
